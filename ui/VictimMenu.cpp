...
namespace AgroResQ
{
    namespace UI
    {
        ...
        void VictimMenu::searchFamily()
        {
            ...
            auto victims =
                victimService.getVictimsByFamily(familyId);
